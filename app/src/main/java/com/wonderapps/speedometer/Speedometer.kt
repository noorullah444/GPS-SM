...
import com.wonderapps.speedometer.Indicators.Indicator
import com.wonderapps.speedometer.Indicators.NoIndicator
import com.wonderapps.speedometer.Interfaces.OnPrintTickLabel
import java.util.*
...
abstract class Speedometer @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : Gauge(context, attrs, defStyleAttr) {
    ...
    private var speedometerWidth = dpTOpx(10f)
